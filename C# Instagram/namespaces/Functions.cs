...
namespace Instagram.namespaces.Functions {
    ...
    public static class Functions {
        ...
        public static void AdminAcc(DataBase dataBase) {
        ...
        public static void UserMenu(DataBase dataBase) {
            Console.Clear();
        ...
        public static void UserAcc(DataBase dataBase) {
